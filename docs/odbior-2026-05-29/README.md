...
1. **Samowystarczalność bindera.** Folder zawiera komplet dokumentów dla Zamawiającego — można go spakować i&nbsp;przekazać niezależnie: <code>tar czf binder.tar.gz docs/odbior-2026-05-29</code>.
