...
interface CatalogNavMRC1000Props {
...
function useCatalogNavController({
  ...
  useEffect(() => {
    const animationRef = scrollAnimationRef;
    return () => {
...
const CatalogNavMRC1000 = (props: CatalogNavMRC1000Props) =>
  renderCatalogNav(useCatalogNavController(props));

export default CatalogNavMRC1000;
