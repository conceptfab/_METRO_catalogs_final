...
function useHeroMRC800ViewModel(data: HeroData) {
...
function renderHeroMRC800({
  ...
  wrapperFlexClasses,
  wrapperStyle,
}: ReturnType<typeof useHeroMRC800ViewModel>) {
  return (
    <section
      id="cover"
...
const HeroMRC800 = ({ data }: HeroMRC800Props) => renderHeroMRC800(useHeroMRC800ViewModel(data));

export default HeroMRC800;
