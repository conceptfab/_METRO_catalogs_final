...
const ProductCodesMRC1000 = ({ data }: ProductCodesSectionProps) => {
  ...
  return (
    ...
    >
      <div
        className="relative mx-auto w-full max-w-[1440px] px-5 pt-6 pb-12 sm:px-8 sm:pt-8 lg:min-h-[960px] lg:px-0 lg:pt-0 lg:pb-[120px]"
        ref={ref}
      >
              ...
              <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-10">
                ...
                {data.modules && data.modules.length > 0 && (
                  <m.div
                    ...
                    className="grid flex-1 grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-6 lg:mt-32 lg:grid-cols-4 lg:gap-6"
                  >
                    {data.modules.map((module) => (
                      <div key={module.image} className="flex flex-col items-center gap-2">
                        ...
                        <div className="qx-packshot-meta">
                          <span className="qx-packshot-code">{module.label}</span>
                        </div>
                      </div>
                    ))}
                  </m.div>
...
export default ProductCodesMRC1000;
